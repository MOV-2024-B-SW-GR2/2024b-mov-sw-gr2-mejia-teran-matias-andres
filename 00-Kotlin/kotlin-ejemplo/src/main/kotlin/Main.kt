...
class Suma( // Constructor primario
    ...
    companion object { // Comparte entre todas las instancias, similar al STATIC
        ...
        fun agregarHistorial(valorTotalSuma:Int){ // Suma.agregarHistorial
            ...
            // Arreglos, deben estar dentro de un bloque de funcion o init
            //Arreglos estaticos
            ...
            //"it" (en ingles "eso") significg el elemento icerado
            arregloDinamico.forEach{ println("Valor Actual (it): $it}")}

            // MAP -> HUTA(Modifica combia) el orreglo
            // 1) Enviomos el nuevo valor de la iteracion
            // 2) Nos devuelve un NUEVO ARREGLO con volores
            // de los iteraciones
            ...
            // Volor acumulado = 8 (Siempre empiezo en 0 en Kotlin)
            // [1,2,3,4,5] -> Acumular "SUMAR" estos volores del arreglo
            ...
            val respuestaReduce: Int = arregloDinamico
                .reduce { acumulado: Int, valorAcual: Int ->
                    return@reduce (acumulado + valorAcual) // -> Cambiar o usar lo Logica de negocio
                }
